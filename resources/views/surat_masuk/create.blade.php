            ...
            <form action="{{ route('surat-masuk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <div>
                        ...
                        <x-text-input id="no_agenda" name="no_agenda" type="text" class="mt-1.5 block w-full" :value="old('no_agenda')" required />
                        <x-input-error :messages="$errors->get('no_agenda')" class="mt-2" />
                    </div>
                    <div>
                        <x-input-label for="no_surat" value="No Surat" />
                        <x-text-input id="no_surat" name="no_surat" type="text" class="mt-1.5 block w-full" :value="old('no_surat')" required />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <div>
                        ...
                        <x-text-input id="pengirim" name="pengirim" type="text" class="mt-1.5 block w-full" :value="old('pengirim')" required />
                        <x-input-error :messages="$errors->get('pengirim')" class="mt-2" />
                    </div>
                    <div>
                        <x-input-label for="perihal" value="Perihal" />
                        <x-text-input id="perihal" name="perihal" type="text" class="mt-1.5 block w-full" :value="old('perihal')" required />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <div>
                        ...
                        <x-text-input id="tanggal_surat" name="tanggal_surat" type="date" class="mt-1.5 block w-full" :value="old('tanggal_surat')" required />
                        <x-input-error :messages="$errors->get('tanggal_surat')" class="mt-2" />
                    </div>
                    <div>
                        <x-input-label for="tanggal_terima" value="Tanggal Terima" />
                        <x-text-input id="tanggal_terima" name="tanggal_terima" type="date" class="mt-1.5 block w-full" :value="old('tanggal_terima')" required />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <div>
                        ...
                        <x-text-input id="jam_terima" name="jam_terima" type="time" class="mt-1.5 block w-full" :value="old('jam_terima')" />
                        <x-input-error :messages="$errors->get('jam_terima')" class="mt-2" />
                    </div>
                    <div>
                        <x-input-label for="keterangan" value="Keterangan" />
                        <x-text-input id="keterangan" name="keterangan" type="text" class="mt-1.5 block w-full" :value="old('keterangan')" />
                ...
                <div class="mb-6">
                    ...
                    <textarea id="isi_ringkas" name="isi_ringkas" rows="4" class="mt-1.5 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg shadow-sm">{{ old('isi_ringkas') }}</textarea>
